...
class IterMessages:
    ...
    async def iter_messages(
        ...
        If you want to get the messages count only, see :meth:`~pyrogram.Client.iter_messages_count`.
        ...
        Example:
            .. code-block:: python
                ...
                async for message in app.iter_messages(chat_id, query="hello", limit=120):
                    print(message.text)

                # Search for pinned messages in chat
                async for message in app.iter_messages(chat_id, filter=enums.MessagesFilter.PINNED):
                    print(message.text)

                # Search for messages containing "hello" sent by yourself in chat
                async for message in app.iter_messages(chat, "hello"):
                    print(message.text)
        """
